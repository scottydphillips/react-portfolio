...
function Homepage() {
	return(
		<div>
			...
			<p>I am currently a Software Developer at <a className='text-indigo-700' href='https://spectrumnetdesigns.com'>Spectrum Net Designs</a> in Grandville, MI, where I work on <a className='text-indigo-700' href='https://auctioneersoftware.com'>Auctioneer Software.</a></p>
